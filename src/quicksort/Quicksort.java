 ...
 * @author 92018448
 */
//The first sort with no changes =
//The number of times the array was parsed was 6
//The number of compare operations was 5
//The second sort list already sorted =
//The number of times the array was parsed was 4
//The number of compare operations was 4
// This algorithm takes O(n log n) comparisons to sort n items. 
//This is a best case data set as it is allreday sorted.
public class QuickSort {
    //Counter variabls 
     static int swapCheckCounter = 0;
    static int parseCounter = 0;
...
//        };
   CatalogueItem arr[] = {
        ...
        ob.printArray(arr);
          ...
          // display data for parse and swap counters
